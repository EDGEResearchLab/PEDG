...
PEDGEParser::PEDGEParser(Stream& stream):
    ...
    m_satellites(m_tinyGps, SENTENCE_ID, 9),
    m_isValid(m_tinyGps, SENTENCE_ID, 10),
    m_hdop(m_tinyGps, SENTENCE_ID, 11),
    m_rail(m_tinyGps, SENTENCE_ID, 12),
    m_temperature(m_tinyGps, SENTENCE_ID, 13),
    m_pressure(m_tinyGps, SENTENCE_ID, 14),
    m_humidity(m_tinyGps, SENTENCE_ID, 15),
    m_battery(m_tinyGps, SENTENCE_ID, 16),
    m_cpm(m_tinyGps, SENTENCE_ID, 17) {
        /* Ignored */
    };
